...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #3386FF">
    <!-- Brand Logo -->
    <a href="user.php" class="brand-link">
      <span class="brand-text font-weight-light">Pharmacia Dimaano | POS</span>
    </a>

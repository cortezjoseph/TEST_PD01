...
if (isset($_POST["btnaddproduct"]))
{
    ...
    $insert=$pdo->prepare("insert into tbl_product(pid,pname,pcategory,saleprice,pstock,pdescription) values(:pid,:pname,:pcategory,:saleprice,:pstock,:pdescription)");
    $insert->bindParam(":pid",$productcode);
            ...
            <div class="card card-success">
              ...
              <form  action="" method="post">
                ...
                <div class="card-body">
                    ...
                    <label>Code</label>
                    <input type="number" class="form-control" id="pid" placeholder="Product Code" name="txtcode" autofocus="autofocus">
                  </div>
